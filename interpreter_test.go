...
`),
			output: []byte(`
1'1  -> {(1,b),(2,c)} ¦- $a_0.b'<c>.0
1'2  -> {(1,b),(2,c)} ¦- $a_0.b'<c>.0
1'3^ -> {(1,b),(2,c),(3,a_0)} ¦- b'<c>.0
`),
		},
		"multiple_inputs": {
			input: []byte(`
...
`),
			output: []byte(`
1'1  -> {(1,b),(2,c)} ¦- ($a_0.0 | b(x_1).0)
1'2  -> {(1,b),(2,c)} ¦- ($a_0.0 | b(x_1).0)
...
`),
			output: []byte(`
1 1  -> {(1,a)} ¦- (0 | $x_1.a'<a>.0)
1 2* -> {(1,a),(2,b_0)} ¦- (0 | $x_1.a'<a>.0)
1'1  -> {(1,a)} ¦- (a(b_0).0 | $x_1.0)
1'2^ -> {(1,a),(2,x_1)} ¦- (a(b_0).0 | 0)
t    -> {(1,a)} ¦- (0 | $x_1.0)
t    -> {(1,a)} ¦- $x_1.(0 | 0)
`),
		},
